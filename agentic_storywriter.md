...
**Output**: Story chapters (2 pages each)
**Details**:
...
- **`chapter_1.md`** through **`chapter_5.md`** - Original story chapters
- **`chapter_1_edited.md`** through **`chapter_5_edited.md`** - Editor-reviewed chapters
...
6. **Author**: Writes 5 chapters telling the complete story
